...
public class Class469 {
	...
	static Class298_Sub37_Sub13 method6048(Class243 class243, int i, int i_20_,
			int i_21_) {
		try {
			RsByteBuffer class298_sub53 = new RsByteBuffer(class243
					.method2315(i, i_20_, (byte) 3));
			Class298_Sub37_Sub13 class298_sub37_sub13 = (new Class298_Sub37_Sub13(
			...
			for (int i_23_ = 0; i_23_ < i_22_; i_23_++)
				((Class298_Sub37_Sub13) class298_sub37_sub13).aClass453_9642
