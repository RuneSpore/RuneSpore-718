...
public final class IDirect3DDevice extends IUnknown {
	...
	public static native long CreateRenderTarget(long l, int i, int i_3_,
			int i_4_, int i_5_, int i_6_, boolean bool);

	public static native long GetSwapChain(long l, int i);

	public static native long CreateAdditionalSwapChain(long l,
	...
	public static native long CreateDepthStencilSurface(long l, int i,
			int i_8_, int i_9_, int i_10_, int i_11_, boolean bool);

	public static native long CreateOffscreenPlainSurface(long l, int i,
			int i_12_, int i_13_, int i_14_);

	public static native long GetBackBuffer(long l, int i, int i_15_, int i_16_);

	public static native int StretchRect(long l, long l_17_, int i, int i_18_,
			int i_19_, int i_20_, long l_21_, int i_22_, int i_23_, int i_24_,
			int i_25_, int i_26_);
	...
	public static native int DrawIndexedPrimitive(long l, int i, int i_39_,
			int i_40_, int i_41_, int i_42_, int i_43_);

	public static native int DrawIndexedPrimitiveIB(long l, long l_44_, int i,
			int i_45_, int i_46_, int i_47_, int i_48_, int i_49_);

	public static native int DrawPrimitive(long l, int i, int i_50_, int i_51_);

	public static native long CreateTexture(long l, int i, int i_52_,
			int i_53_, int i_54_, int i_55_, int i_56_);

	public static native long CreateCubeTexture(long l, int i, int i_57_,
			int i_58_, int i_59_, int i_60_);

	public static native long CreateVolumeTexture(long l, int i, int i_61_,
	...
	public static native int Reset(long l,
			D3DPRESENT_PARAMETERS d3dpresent_parameters);
