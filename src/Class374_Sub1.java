...
public class Class374_Sub1 extends Class374 {
	...
	void method4621() {
		...
		if (class298_sub50 != null) {
			...
			class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(i_1_
					| i_0_ << 16, -1426845039);
	...
	void method4613() {
		...
		if (class298_sub50 != null) {
			...
			class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(i_4_
					| i_3_ << 16, -1629465959);
	...
	void method4618(byte i) {
		try {
			...
			if (class298_sub50 != null) {
				...
				class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(i_8_
						| i_7_ << 16, 121434419);
				class298_sub36.aClass298_Sub53_Sub2_7396.writeShort128(i_6_
						| i_9_ << 15);
	...
	void method4622() {
		...
		if (class298_sub50 != null) {
			...
			class298_sub36.aClass298_Sub53_Sub2_7396.writeInt(i_11_
					| i_10_ << 16, -611244662);
